...
class AgePredictor:
    def __init__(self, model_path):
        ...
        try:
            ...
            print(f'AgePredictor: Error initializing: {e}')
            raise e
    ...
    def predict(self, pil_img):
        try:
            ...
            print(f'AgePredictor: Error predicting age: {e}')
            torch.cuda.empty_cache()
            raise e
